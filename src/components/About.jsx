        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-5 -right-4 sm:-right-6 bg-white rounded-2xl shadow-2xl px-6 py-5 hidden sm:flex flex-col items-center border border-stone-100">
              <p className="text-4xl font-bold font-serif text-accent leading-none">5+</p>
              <p className="text-stone-500 text-sm mt-1 font-medium text-center">godina iskustva</p>
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-stone-600 text-base md:text-lg leading-relaxed mb-5">
              Tražite savršen smeštaj za vaš odmor u Polihronuu?
            ...
            <p className="text-stone-500 text-base leading-relaxed mb-8">
              Apartman sadrži Smart TV, Wi-Fi i klimu. Prijem je porodičan i topao —
              svaki gost je poseban za nas, a vaš komfor je naš prioritet.
            </p>
