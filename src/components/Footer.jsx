      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12 pb-12 border-b border-stone-800">
          ...
          <div className="sm:col-span-2">
            <a href="#home" className="flex items-center gap-2.5 mb-4 w-fit group">
              ...
              <div className="leading-none">
                <span className="font-serif font-semibold text-lg text-white tracking-tight block">Apartmani</span>
                <span className="text-xs font-medium tracking-widest uppercase text-accent">Polihrono</span>
              </div>
            </a>
            <p className="text-stone-500 text-sm leading-relaxed max-w-xs mb-6">
              Savršen smeštaj za vaš odmor u Polihronuu, Grčka.
              Na samo 80m od mora — toplo, porodično i udobno.
            </p>
